...
<?php while (have_posts()) : the_post(); ?>
    ...
    <div class="ui yellow inverted segment center aligned" style="color:black">
        ...
        <h2 style="color:black" class="thinkerbell">
            ...
            Ah<span class="no-thinkerbell"> !</span> et.. n'oubliez pas votre déguisement<span class="no-thinkerbell"> ! </span> <br>
            <img src="http://bqhdcmfo.preview.infomaniak.com/wp-content/uploads/2016/02/Gros_Smileys_151.gif" alt="Gros_Smileys_151" />
            <br>
